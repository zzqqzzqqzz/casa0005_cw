...
```{r seasonal variation of each type}
head(crime)
head(crime_2020_average)
head(crime_2019)
...
```{r frequency distribution + wilcox}
head(crime_2019)
...
#replace keywords for different maps
```

```{r global morans i by type 2019}
...
```{r global morans i by type 2020}
